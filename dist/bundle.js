...
(function (global, factory) {
    ...
    function animate(element, animation, duration, origin, out) {
        ...
        var p = promise(function (resolve) {
            ...
            element.one(animationend || 'animationend', function (e) {
                e.promise = p;
                p.then(reset);
                resolve();
        ...
        if (flip) {
            $.each(dirs, function (dir, ref) {
                ...
                if (position[align] < boundary[align] || position[align] + dim[prop] > boundary[alignFlip]) {
                    ...
                    attach[dir] === 'center' && (apply(centerOffset, centerTargetOffset) || apply(-centerOffset, -centerTargetOffset)) || apply(elemOffset, targetOffset);
                }
    ...
    */
    ...
    ready(function () {
        ...
        on(document, 'MSGestureEnd gestureend', function (e) {
            ...
            var dir = e.velocityX > 1 ? 'Right' : e.velocityX < -1 ? 'Left' : e.velocityY > 1 ? 'Down' : e.velocityY < -1 ? 'Up' : null;
        ...
        methods: {
            ...
            toggleElement: function toggleElement(targets, show, animate) {
                ...
                var toggles,
                    ...
                    return promise.all(targets.toArray().map(function (el) {
                ...
                return Transition.cancel(el).then(function () {
                    ...
                    return promise(function (resolve) {
                        return requestAnimationFrame(function () {
                            ...
                            (show ? Transition.start(el, assign(this$1.initProps, { overflow: 'hidden', height: endHeight }), Math.round(this$1.duration * (1 - height / endHeight)), this$1.transition) : Transition.start(el, this$1.hideProps, Math.round(this$1.duration * (height / endHeight)), this$1.transition).then(function () {
        ...
        UIkit.component('cover', {
            ...
            ready: function ready() {
                ...
                if (this.automute) {
                    ...
                    this.$el.attr('src', "" + src + (~src.indexOf('?') ? '&' : '?') + "enablejsapi=1&api=1").on('load', function (ref) {
                        var target = ref.target;
    ...
    function Modal$1(UIkit) {
        ...
        UIkit.modal.dialog = function (content, options) {
            ...
            var dialog = UIkit.modal("<div class=\"uk-modal\">\n                <div class=\"uk-modal-dialog\">" + content + "</div>\n             </div>", options);
        ...
        UIkit.component('navbar-dropbar', {
            ...
            methods: {
                ...
                transitionTo: function transitionTo(height) {
                    ...
                    return Transition.cancel(this.$el).then(function () {
                        return Transition.start(this$1.$el, { height: height }, this$1.duration);
                    });
                }
        ...
        UIkit.component('toggle', {
            ...
            events: [{
                ...
                handler: function handler(e) {
                    ...
                    if ($__default(e.target).closest('a[href="#"], button').length || link.length && (this.cls || !this.target.is(':visible') || link.attr('href')[0] === '#' && this.target.is(link.attr('href')))) {
                        e.preventDefault();
                    }
        ...
        UIkit.component('lightbox', {
            ...
            computed: {
                ...
                toggles: function toggles() {
                    ...
                    return $(this.toggle, this.$el).each(function (_, el) {
            ...
            methods: {
                ...
                show: function show(index) {
                    ...
                    if (!this.modal) {
                        ...
                        this.modal.$el.on('hidden', this.hide).on('click', "[" + this.attrItem + "]", function (e) {
                            e.preventDefault();
        ...
        UIkit.mixin({
            ...
            events: {
                ...
                showitem: function showitem(e) {
                    ...
                    var video = $('<video class="uk-responsive-width" controls></video>').on('loadedmetadata', function () {
                        return this$1.setItem(item, video.attr({ width: video[0].videoWidth, height: video[0].videoHeight }), video[0].videoWidth, video[0].videoHeight);
    ...
    function plugin$2(UIkit) {
        ...
        UIkit.component('notification', {
            ...
            created: function created() {
                ...
                this.$mount($("<div class=\"" + this.clsMsg + (this.status ? " " + this.clsMsg + "-" + this.status : '') + "\">\n                    <a href=\"#\" class=\"" + this.clsClose + "\" data-uk-close></a>\n                    <div>" + this.message + "</div>\n                </div>").appendTo(containers[this.pos].show())[0]);
            },
        ...
        UIkit.component('parallax', {
            ...
            update: [{
                ...
                write: function write() {
                    ...
                    if (!this._active) {
                        Object.keys(getCss(this.props, 0)).forEach(function (prop) {

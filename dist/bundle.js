...
(function (global, factory) {
				...
				__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__)) : global.UIkitIcons = factory();
})(undefined, function () {
				'use strict';
...
(function (global, factory) {
    ( false ? 'undefined' : _typeof(exports)) === 'object' && typeof module !== 'undefined' ? module.exports = factory(__webpack_require__(0)) :  true ? !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(0)], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory),
				...
				__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__)) : global.UIkit = factory(global.jQuery);
})(undefined, function ($) {
    'use strict';
    ...
    function on(el, type, listener, useCapture) {
        ...
        type.split(' ').forEach(function (type) {
            return toNode(el).addEventListener(type, listener, useCapture);
        });
    }
    ...
    function off(el, type, listener, useCapture) {
        ...
        type.split(' ').forEach(function (type) {
            return toNode(el).removeEventListener(type, listener, useCapture);
        });
    }
    ...
    function transition(element, props, duration, transition) {
        ...
        return promise(function (resolve, reject) {
            ...
            var timer = setTimeout(function () {
                return element.trigger(transitionend);
            }, duration);
            ...
            element.addClass('uk-transition').css('transition', "all " + duration + "ms " + transition).css(props);
        });
    }
    ...
    function animate(element, animation, duration, origin, out) {
        ...
        return promise(function (resolve, reject) {
            ...
            one(element, (animationend || 'animationend') + " " + animationcancel, function (ref) {
                ...
                requestAnimationFrame(function () {
                    if (!hasReset) {
                        ...
                        requestAnimationFrame(function () {
                            return element.removeClass(clsCancelAnimation);
                        });
                    }
                });
            ...
            element.css('animation-duration', duration + "ms").addClass(cls);
    ...
    function isWithin(element, selector) {
        element = $__default(element);
        return element.is(selector) ? true : isString(selector) ? element.parents(selector).length : toNode(selector).contains(element[0]);
    }
    ...
    function isInView(element, offsetTop, offsetLeft) {
        ...
        return rect.bottom >= -1 * offsetTop && rect.right >= -1 * offsetLeft && rect.top <= window.innerHeight + offsetTop && rect.left <= window.innerWidth + offsetLeft;
    }
    ...
    promise.all = function (iterable) {
        return hasPromise ? Promise.all(iterable) : $__default.when.apply($__default, iterable);
    };
    ...
    function toJQuery(element, context) {
        ...
        try {
            ...
            if (context && isContextSelector(element) && element[0] !== '>') {
                ...
                var fn = contextSelectors[element[0]],
                    selector = element.substr(1);
    ...
    var hasTouch = 'ontouchstart' in window || window.DocumentTouch && document instanceof DocumentTouch || navigator.msPointerEnabled && navigator.msMaxTouchPoints // IE 10
    ...
    */
    ...
    function listen(cb) {
        ...
        return promise(function (resolve) {
            ...
            one(window, 'message', function (_, data) {
                return resolve(data);
            }, false, function (ref) {
                var data = ref.data;
    ...
    */
    ...
    var boot = function boot(UIkit) {
        ...
        if (Observer) {
            ...
            ready(function () {
                ...
                on(doc, 'DOMNodeInserted', function (e) {
                    return apply(e.target, connect);
                });
                on(doc, 'DOMNodeRemoved', function (e) {
    ...
    var stateAPI = function stateAPI(UIkit) {
        ...
        UIkit.prototype._initData = function () {
            ...
            for (var key in defaults) {
                this$1.$props[key] = this$1[key] = hasOwn(data, key) && !isUndefined(data[key]) ? coerce(props[key], data[key], el) : isArray(defaults[key]) ? defaults[key].concat() : defaults[key];
            }
        };
        ...
        function parseOptions(options, args) {
            ...
            try {
                ...
                return !options ? {} : options[0] === '{' ? JSON.parse(options) : args.length && !~options.indexOf(':') ? (obj = {}, obj[args[0]] = options, obj) : options.split(';').reduce(function (options, option) {
    ...
    var classAPI = function classAPI(UIkit) {
        ...
        UIkit.prototype.$toggleClass = function () {
            ...
            for (var i = 1; i < (args && args.length); i++) {
                args[0] && supportsForce ? args[0].toggle(args[i], force) : args[0][(!isUndefined(force) ? force : !args[0].contains(args[i])) ? 'add' : 'remove'](args[i]);
            }
        };

        function apply(el, args, fn) {
            (args = getArgs(args, el)) && (supportsMultiple ? args[0][fn].apply(args[0], args.slice(1)) : args.slice(1).forEach(function (cls) {
                return args[0][fn](cls);
            }));
        }
        ...
        function getArgs(args, el) {
            ...
            args.forEach(function (arg, i) {
                return i > 0 && isString(arg) && ~arg.indexOf(' ') && Array.prototype.splice.apply(args, [i, 1].concat(args[i].split(' ')));
            });
    ...
    var Togglable = {
        ...
        methods: {
                ...
                return promise(function (resolve) {
                    ...
                    if (!this$1.queued || !isUndefined(animate) || !isUndefined(show) || !this$1.hasAnimation || targets.length < 2) {
                        ...
                        var body = document.body,
                            ...
                            el = toggled[0],
                            inProgress = Animation.inProgress(el) && this$1.$hasClass(el, 'uk-animation-leave') || Transition.inProgress(el) && el.style.height === '0px';
            ...
            toggleNow: function toggleNow(targets, show) {
                ...
                return promise(function (resolve) {
                    return promise.all($__default(targets).toArray().map(function (el) {
            ...
            _toggleElement: function _toggleElement(el, show, animate) {
                ...
                show = isBoolean(show) ? show : Animation.inProgress(el) ? this.$hasClass(el, 'uk-animation-leave') : Transition.inProgress(el) ? el[0].style.height === '0px' : !this.isToggled(el);

                if ($trigger(el, "before" + (show ? 'show' : 'hide'), [this]).result === false) {
                    return promise.reject();
                }

                var def = (animate === false || !this.hasAnimation ? this._toggleImmediate : this.hasTransition ? this._toggleHeight : this._toggleAnimation)(el, show);
            ...
            _toggleHeight: function _toggleHeight(el, show) {
                ...
                return (show ? Transition.start(el, assign({}, this.initProps, { overflow: 'hidden', height: endHeight }), Math.round(this.duration * (1 - height / endHeight)), this.transition) : Transition.start(el, this.hideProps, Math.round(this.duration * (height / endHeight)), this.transition).then(function () {
                    return this$1._toggle(el, false);
                })).then(function () {
                    return el.css(this$1.initProps);
                });
            },
            ...
            methods: {
                ...
                toggle: function toggle(item, animate) {
                    ...
                    item.add(!this.multiple && active).each(function (i, el) {
                        ...
                        var isItem = el.is(item),
                            state = isItem && !el.hasClass(this$1.clsOpen);
        ...
        UIkit.component('cover', {
            ...
            update: {
                ...
                write: function write() {
                    ...
                    this.$el.css({ width: '', height: '' }).css(Dimensions.cover({ width: this.width || this.el.clientWidth, height: this.height || this.el.clientHeight }, { width: this.parent.offsetWidth, height: this.parent.offsetHeight }));
                },
        ...
        UIkit.component('drop', {
            ...
            events: [{
                ...
                handler: function handler(e) {
                    ...
                    if (active && active !== this && active.toggle && ~active.toggle.mode.indexOf('hover') && !isWithin(e.target, active.$el) && !isWithin(e.target, active.toggle.$el)) {
                        active.hide(false);
                    }
        ...
        UIkit.component('height-match', {
            ...
            update: {
                ...
                read: function read() {
                    ...
                    this.rows = !this.row ? [this.match(this.elements)] : this.elements.toArray().reduce(function (rows, el) {
            ...
            methods: {
                ...
                match: function match(elements) {
                    ...
                    elements = elements.each(function (_, el) {
        ...
        registerComponent('spinner', {
            ...
            connected: function connected() {
                ...
                this.svg.then(function (svg) {
                    return this$1.ratio !== 1 && $__default(svg).find('circle').css('stroke-width', 1 / this$1.ratio);
                }, noop);
            }
    ...
    var Modal$1 = function Modal$1(UIkit) {
        ...
        UIkit.modal.alert = function (message, options) {
            ...
            return promise(function (resolve) {
                return UIkit.modal.dialog(" <div class=\"uk-modal-body\">" + (isString(message) ? message : $__default(message).html()) + "</div> <div class=\"uk-modal-footer uk-text-right\"> <button class=\"uk-button uk-button-primary uk-modal-close\" autofocus>" + options.labels.ok + "</button> </div> ", options).$el.on('hide', resolve);
            });
        };
    ...
    var Navbar = function Navbar(UIkit) {
        ...
        UIkit.component('navbar', {
            ...
            ready: function ready() {
                ...
                if (this.dropbar) {
                    UIkit.navbarDropbar(query(this.dropbar, this.$el) || $__default('<div></div>').insertAfter(this.dropbarAnchor || this.$el), { clsDrop: this.clsDrop, mode: this.dropbarMode, duration: this.duration, navbar: this });
                }
            },

            update: function update() {

                UIkit.drop($__default(this.dropdown + " ." + this.clsDrop, this.$el).filter(function (_, el) {
        ...
        UIkit.component('responsive', {
            ...
            update: {
                ...
                read: function read() {
                    ...
                    this.dim = this.$el.is(':visible') && this.width && this.height ? { width: this.$el.parent().width(), height: this.height } : false;
                },
        ...
        UIkit.component('scroll', {
            ...
            methods: {
                ...
                scrollTo: function scrollTo(el) {
                    ...
                    $__default('html,body').stop().animate({ scrollTop: Math.round(target) }, this.duration, this.easing).promise().then(function () {
                        return this$1.$el.trigger('scrolled', [this$1, el]);
                    });
                }
                    ...
                    this.elements.each(function (i, el) {
                        ...
                        if (data.show) {
                            ...
                            if (!data.inview && !data.timer) {
                                ...
                                var show = function show() {
                                    $el.css('visibility', '').addClass(this$1.inViewClass).toggleClass(cls).trigger('inview');
                            ...
                            if (data.inview && this$1.repeat) {
                                ...
                                $el.removeClass(this$1.inViewClass).toggleClass(cls).css('visibility', this$1.hidden ? 'hidden' : '').trigger('outview');
            ...
            update: [{
                ...
                read: function read() {
                    ...
                    var scroll = window.pageYOffset + this.offset + 1,
                        max = docHeight() - window.innerHeight + this.offset;
                ...
                write: function write() {
                    ...
                    if (this.active) {
                        this.$el.trigger('active', [this.active, (this.closest ? this.active.closest(this.closest) : this.active).addClass(this.cls)]);
                    }
                },
        ...
        UIkit.component('sticky', {
            ...
            update: [{
                ...
                write: function write() {
                    ...
                    var outerHeight = (this.isActive ? this.placeholder : this.$el)[0].offsetHeight,
                        el;
                    ...
                    if (this.inactive || scroll < this.top || this.showOnUp && (scroll <= this.top || dir === 'down' || dir === 'up' && !this.isActive && scroll <= this.bottomOffset)) {
                        ...
                        if (this.animation && scroll > this.topOffset) {
                            Animation.cancel(this.$el).then(function () {
                                return Animation.out(this$1.$el, this$1.animation).then(function () {
                                    return this$1.hide();
                                }, noop);
                            });
                        } else {
            ...
            methods: {
                ...
                update: function update() {
                    ...
                    if (this.showOnUp) {
                        requestAnimationFrame(function () {
                            return this$1.$addClass(this$1.clsFixed);
                        });
                    } else {
    ...
    var Svg = function Svg(UIkit) {
        ...
        UIkit.component('svg', {
            ...
            connected: function connected() {
                ...
                this.svg = this.getSvg().then(function (doc) {
                    return promise(function (resolve, reject) {
                        ...
                        if (!this$1.icon) {
                            ...
                            if (!svg) {
                                ...
                                html = html.replace(/<symbol/g, "<svg" + (!~html.indexOf('xmlns') ? ' xmlns="http://www.w3.org/2000/svg"' : '')).replace(/symbol>/g, 'svg>');
            ...
            disconnected: function disconnected() {
                ...
                if (this.svg) {
                    this.svg.then(function (svg) {
                        return svg.parentNode && svg.parentNode.removeChild(svg);
                    }, noop);
                    this.svg = null;
                }
            },
        ...
        UIkit.component('toggle', {
            ...
            events: [{
                ...
                handler: function handler(e) {
                    ...
                    if ($__default(e.target).closest('a[href="#"], button').length || link && (this.cls || !this.target.is(':visible') || link.hash && this.target.is(link.hash))) {
                        e.preventDefault();
                    }
                    ...
                    this.units.forEach(function (unit) {
                        ...
                        if (this$1[unit].text() !== digits) {
                            ...
                            if (digits.length !== el.children().length) {
                                el.empty().append(digits.map(function () {
                                    return '<span></span>';
                                }).join(''));
                            }

                            digits.forEach(function (digit, i) {
                                return el[0].childNodes[i].innerText = digit;
                            });
                        }
                    });
                }
            ...
            methods: {
                ...
                move: function move(e) {
                    ...
                    this.slides.each(function (i, el) {
                        return this$1.$toggleClass(el, this$1.clsActive, i === index || i === nextIndex);
                    });
                ...
                show: function show(index, force) {
                    ...
                    var hasPrev = this.slides.hasClass('uk-active'),
                        dir = index === 'next' ? 1 : index === 'previous' ? -1 : index < this.index ? -1 : 1;
                    ...
                    this._animation = new Transitioner(!prev ? 'scale' : this.animation, this.transition, prev || next, next, dir, function () {
                        ...
                        if (this$1.stack.length) {
                            requestAnimationFrame(function () {
                                return this$1.show(this$1.stack.shift(), true);
                            });
                        } else {
                ...
                startAutoplay: function startAutoplay() {
                    ...
                    if (this.autoplay) {
                        this.interval = setInterval(function () {
                            !this$1.isHovering && this$1.show('next');
                        }, this.autoplay);
                    }
                },
        ...
        var Animations = {
            ...
            slide: {
                ...
                show: function show(dir) {
                    return [{ transform: "translate3d(" + dir * -100 + "%, 0, 0)" }, { transform: 'translate3d(0, 0, 0)' }];
                },
                ...
                translate: function translate(percent, dir) {
                    return [{ transform: "translate3d(" + dir * -100 * percent + "%, 0, 0)" }, { transform: "translate3d(" + dir * 100 * (1 - percent) + "%, 0, 0)" }];
                }
            ...
            scale: {
                ...
                show: function show() {
                    return [{ opacity: 0, transform: "scale3d(" + (1 - diff) + ", " + (1 - diff) + ", 1)" }, { opacity: 1, transform: 'scale3d(1, 1, 1)' }];
                },
                ...
                translate: function translate(percent) {
                    ...
                    return [{ opacity: 1 - percent, transform: "scale3d(" + scale1 + ", " + scale1 + ", 1)" }, { opacity: percent, transform: "scale3d(" + scale2 + ", " + scale2 + ", 1)" }];
                }
            ...
            swipe: {
                ...
                show: function show(dir) {
                    ...
                    if (dir < 0) {
                        return [{ opacity: 1, transform: "translate3d(100%, 0, 0)", zIndex: 0 }, { opacity: 1, transform: "scale3d(1, 1, 1) translate3d(0, 0, 0)", zIndex: -1 }];
                    } else {
                        return [{ opacity: 0.3, transform: "scale3d(" + (1 - diff) + ", " + (1 - diff) + ", 1) translate3d(-20%, 0, 0)", zIndex: -1 }, { opacity: 1, transform: 'translate3d(0, 0, 0)', zIndex: 0 }];
                    }
                },
                ...
                translate: function translate(percent, dir) {
                    ...
                    if (dir < 0) {
                        ...
                        return [{ opacity: 1, transform: "translate3d(" + 100 * percent + "%, 0, 0)", zIndex: 0 }, { opacity: 0.3 + 0.7 * percent, transform: "scale3d(" + scale + ", " + scale + ", 1) translate3d(" + -20 * (1 - percent) + "%, 0, 0)", zIndex: -1 }];
                    } else {
                        scale = 1 - diff * percent;
                        return [{ opacity: 1 - 0.7 * percent, transform: "scale3d(" + scale + ", " + scale + ", 1) translate3d(" + -20 * percent + "%, 0, 0)", zIndex: -1 }, { opacity: 1, transform: "translate3d(" + 100 * (1 - percent) + "%, 0, 0)", zIndex: 0 }];
                    }
                }
        ...
        function Transitioner(animation, transition, current, next, dir, cb) {
            ...
            return {
                ...
                show: function show(duration, percent) {
                    ...
                    return promise.all([Transition.start(current, props[0], duration, transition), Transition.start(next, props[1], duration, transition)]).then(function () {
                        this$1.reset();
                        cb();
                    }, noop);
                },
                ...
                stop: function stop() {
                    return promise.all([Transition.stop(next), Transition.stop(current)]);
                },

                cancel: function cancel() {
                    return promise.all([Transition.cancel(next), Transition.cancel(current)]);
                },
                ...
                forward: function forward(duration) {
                    ...
                    return promise.all([Transition.cancel(next), Transition.cancel(current)]).then(function () {
                        return this$1.show(duration, percent);
                    });
                },
    ...
    function plugin$1(UIkit) {
        ...
        UIkit.component('lightbox', {
            ...
            computed: {
                ...
                toggles: function toggles() {
                    ...
                    this._changed = !this._toggles || toggles.length !== this._toggles.length || toggles.toArray().some(function (el, i) {
                        return el !== this$1._toggles.get(i);
                    });
        ...
        UIkit.component('lightbox-panel', {
            ...
            created: function created() {
                ...
                this.items.forEach(function (el, i) {
                    return this$1.list.append("<li class=\"" + this$1.clsItem + " item-" + i + "\"></li>");
                });
            },
            ...
            events: [{
                ...
                handler: function handler(_, item) {
                    ...
                    if (type === 'image' || source.match(/\.(jp(e)?g|png|gif|svg)$/i)) {
                        ...
                        var video = $$$1('<video controls playsinline uk-video></video>').on('loadedmetadata', function () {
                            return this$1.setItem(item, video.attr({ width: video[0].videoWidth, height: video[0].videoHeight }));
                        }).on('error', function () {
                            return this$1.setError(item);
                        }).attr('src', source);
                        ...
                        getImage("//img.youtube.com/vi/" + id + "/maxresdefault.jpg").then(function (img) {
                            //youtube default 404 thumb, fall back to lowres
                            if (img.width === 120 && img.height === 90) {
                                getImage("//img.youtube.com/vi/" + id + "/0.jpg").then(function (img) {
                                    return setIframe(img.width, img.height);
                                }, setIframe);
                            } else {
                        ...
                        ajax$$1({ type: 'GET', url: "//vimeo.com/api/oembed.json?url=" + encodeURI(source), jsonp: 'callback', dataType: 'jsonp' }).then(function (ref) {
                            var height = ref.height;
                            var width = ref.width;
            ...
            methods: {
                ...
                hide: function hide() {
                    ...
                    this.slides.removeClass(this.clsActive).each(function (_, el) {
                        return Transition.stop(el);
                    });
        ...
        function animate(el, animation, dir) {
            ...
            el.each(function (i) {
                return Animation[dir](el.eq(i).attr('hidden', false), animation).then(function () {
    ...
    function plugin$3(UIkit) {
        ...
        UIkit.component('notification', {
            ...
            created: function created() {
                ...
                this.$mount($$$1("<div class=\"" + this.clsMsg + (this.status ? " " + this.clsMsg + "-" + this.status : '') + "\"> <a href=\"#\" class=\"" + this.clsClose + "\" data-uk-close></a> <div>" + this.message + "</div> </div>").appendTo(containers[this.pos].show())[0]);
            },
        ...
        UIkit.component('sortable', {
            ...
            methods: {
                ...
                init: function init(e) {
                    ...
                    if (!placeholder.length || target.is(':input') || this.handle && !isWithin(target, this.handle) || e.button && e.button !== 0 || isWithin(target, "." + this.clsNoDrag) || e.defaultPrevented) {
                        return;
                    }
                ...
                start: function start(e) {
                    ...
                    this.drag = $$$1(this.placeholder[0].outerHTML.replace(/^<li/i, '<div').replace(/li>$/i, 'div>')).attr('uk-no-boot', '').addClass(this.clsDrag + " " + this.clsCustom).css({
                ...
                scroll: function scroll() {
                    ...
                    this.touched.forEach(function (sortable) {
                        return sortable.$el.children().removeClass(classes);
                    });
                ...
                write: function write() {
                    ...
                    this.rows.forEach(function (row) {
                        return row.forEach(function (el, i) {
                            return el.style.transform = "translateY(" + (i % 2 ? this$1.scrolled : this$1.scrolled / 8) + "px)";
                        });
                    });
                },
    ...
    function plugin$8(UIkit) {
        ...
        mixin.parallax = {
            ...
            computed: {
                ...
                props: function props$1() {
                    ...
                    return props.reduce(function (props, prop) {
                        ...
                        var start = (!isUndefined(values[1]) ? values[0] : prop === 'scale' ? 1 : isCssProp ? this$1.$el.css(prop) : 0) || 0,
            ...
            methods: {
                ...
                reset: function reset() {
                    ...
                    Object.keys(this.getCss(0)).forEach(function (prop) {
                        return this$1.$el.css(prop, '');
                    });
                },
                    ...
                    return Object.keys(props).reduce(function (css, prop) {
                        ...
                        switch (prop) {
                            ...
                            case 'y':
                                ...
                                var ref = ['x', 'y'].map(function (dir) {
                                    return prop === dir ? value + values.unit : props[dir] ? getValue(props[dir], percent) + props[dir].unit : 0;
                                });
                                var x = ref[0];
                                var y = ref[1];
        ...
        function parseColor(color) {
            return color.split(/[(),]/g).slice(1, -1).concat(1).slice(0, 4).map(function (n) {
                return parseFloat(n);
            });
        }

        function getValue(prop, percent) {
            return +(!isUndefined(prop.diff) ? prop.start + prop.diff * percent * (prop.start < prop.end ? 1 : -1) : +prop.end).toFixed(2);
        }
    }
...
var Scroll = function () {
  function Scroll(maxPages) {
    ...
    document.addEventListener('scroll', function () {
      if (_this.currentPos != _this.maxPages) {
        window.scrollTo(0, 0);
      }
      if (window.pageYOffset === 0 && _this.currentPos == _this.maxPages) {
  ...
  _createClass(Scroll, [{
    ...
    key: 'changeInfo',
    value: function changeInfo(index) {
      this.info.innerHTML = index + '/' + this.maxPages;
    }
  }, {
    key: 'beforeMove',
    value: function beforeMove(index) {
    ...
    key: 'afterMove',
    value: function afterMove(index) {
...
var Slider = function () {
  function Slider(images) {
    ...
    this.buttons.innerHTML = this.images.map(function (obj, i) {
    ...
    this.content.onload = function () {
      return _this.content.removeAttribute('style');
    };
    this.content.addEventListener('transitionend', function () {
      return _this.changePath();
    });
  }
  ...
  _createClass(Slider, [{
    ...
    key: 'changePath',
    value: function changePath() {
      var _this2 = this;

      if (!this.change) {
        this.content.setAttribute('src', 'img/' + this.images.find(function (obj) {
...
var _uikitIcons = __webpack_require__(1);
...
var scroll = new _scroll2.default(4);
var slider = new _slider2.default(images);
...
module.exports = "<!DOCTYPE html>\r\n<html lang=\"en\">\r\n<head>\r\n  <meta charset=\"UTF-8\">\r\n  <title>{$title}</title>\r\n  <link rel=\"stylesheet\" href=\"../node_modules/uikit/dist/css/uikit.min.css\">\r\n</head>\r\n<body scroll=\"no\">\r\n<div class=\"uk-height-1-1 uk-overflow-hidden\">\r\n  <div class=\"main uk-height-1-1\">\r\n    <section class=\"uk-height-1-1 uk-overflow-hidden uk-position-relative illuminator\">\r\n      <nav class=\"uk-navbar-nav uk-flex-between uk-container uk-flex-middle uk-container-expand uk-section-secondary\"\r\n           uk-navbar>\r\n        <div class=\"\">\r\n          <div class=\"logo uk-text-uppercase\">\r\n            Illuminator<br>\r\n            <span class=\"logo__span uk-text-lowercase uWsk-navbar-subtitle\">дизайнерские светильники</span>\r\n          </div>\r\n        </div>\r\n        <ul class=\"uk-navbar-nav\">\r\n          <li class=\"\"><a href=\"#\" class=\"\">Все товары</a></li>\r\n          <li class=\"\"><a href=\"#\" class=\"\">Светильники</a></li>\r\n          <li class=\"\"><a href=\"#\" class=\"\">Новинки</a></li>\r\n          <li class=\"\"><a href=\"#\" class=\"\">Скидки</a></li>\r\n          <li class=\"\"><a href=\"#\" class=\"\">Семейства</a></li>\r\n          <li class=\"\"><a href=\"#\" class=\"\">Дизайнеры</a></li>\r\n        </ul>\r\n        <div class=\"uk-flex uk-flex-middle\">\r\n          <div class=\"uk-margin-right uk-flex-middle uk-iconnav\">\r\n            <spa uk-icon=\"icon: phone\"></spa>\r\n            <span class=\"uk-margin-small-left\">7(989)282-88-88</span>\r\n          </div>\r\n          <div class=\"uk-flex uk-flex-middle uk-iconnav\">\r\n            <a href=\"#\" uk-icon=\"icon: heart; ratio: 1.2\"></a>\r\n            <a href=\"#\" uk-icon=\"icon: mail; ratio: 1.2\"></a>\r\n            <a class=\"uk-flex uk-flex-middle uk-flex-column-reverse\" href=\"#\" uk-icon=\"icon: search; ratio: 1.2\">\r\n              <span class=\"uk-text-small\">Поиск</span>\r\n            </a>\r\n            <a href=\"#\" uk-icon=\"icon: question; ratio: 1.2\"></a>\r\n            <a href=\"#\" uk-icon=\"icon: cart; ratio: 1.2\"></a>\r\n            <a href=\"#\" uk-icon=\"icon: sign-out; ratio: 1.2\"></a>\r\n            <a href=\"#\" uk-icon=\"icon: lock; ratio: 1.2\"></a>\r\n          </div>\r\n        </div>\r\n      </nav>\r\n      <div class=\"info uk-position-absolute uk-flex uk-flex-middle uk-light\">\r\n        <div class=\"\">\r\n          <h2 class=\"uk-text-bold uk-text-uppercase\">Illuminate</h2>\r\n          <p class=\"\">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Adipisci aliquid aperiam at\r\n            aut cumque delectus dicta dignissimos distinctio dolorem dolorum, earum est expedita hic illo impedit\r\n            nesciunt\r\n            placeat ratione reiciendis, tempore vel velit veritatis voluptas! Blanditiis corporis dicta, dolore\r\n            explicabo\r\n            fugiat fugit harum id in ipsa ipsum magni maxime mollitia nihil odit quam quibusdam quod rem repudiandae\r\n            similique velit! Accusantium animi cumque deleniti ducimus harum, illo minima tempore ut vitae.\r\n          </p>\r\n        </div>\r\n      </div>\r\n    </section>\r\n    <section class=\"uk-height-1-1 uk-overflow-hidden uk-position-relative\">\r\n      <div class=\"uk-height-1-1\">\r\n        <div class=\"content uk-position-relative uk-height-1-1\">\r\n          <img src=\"" + __webpack_require__(20) + "\" alt=\"\" class=\"content__img uk-height-1-1 uk-width-1-1\">\r\n          <img src=\"" + __webpack_require__(21) + "\" alt=\"\" class=\"content__img uk-height-1-1 uk-width-1-1\">\r\n          <img src=\"" + __webpack_require__(22) + "\" alt=\"\" class=\"content__img uk-height-1-1 uk-width-1-1\">\r\n          <img src=\"" + __webpack_require__(23) + "\" alt=\"\" class=\"content__img uk-height-1-1 uk-width-1-1\">\r\n        </div>\r\n        <a href=\"\" class=\"uk-position-absolute slider__control slider__control--right uk-slidenav-large\"\r\n           uk-slidenav-next></a>\r\n        <a href=\"\" class=\"uk-position-absolute slider__control slider__control--left uk-slidenav-large\"\r\n           uk-slidenav-previous></a>\r\n        <div\r\n          class=\"buttons-container uk-position-absolute uk-padding uk-position-bottom uk-position-small uk-position-absolute uk-container uk-light uk-flex uk-flex-column uk-flex-between uk-flex-middle\">\r\n          <h2 class=\" uk-align-center uk-text-uppercase\">Выберите свой стиль</h2>\r\n          <div class=\"buttons-container__row uk-flex uk-flex-between uk-margin-remove uk-width-1-1\" uk-grid>\r\n          </div>\r\n        </div>\r\n      </div>\r\n    </section>\r\n    <section class=\"uk-height-1-1 uk-overflow-hidden uk-position-relative family\">\r\n      <div class=\"info uk-position-absolute uk-flex uk-flex-middle uk-light\">\r\n        <div class=\"\">\r\n          <h2 class=\"uk-text-bold uk-text-uppercase\">Семейства</h2>\r\n          <p class=\"\">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Adipisci aliquid aperiam at\r\n            aut cumque delectus dicta dignissimos distinctio dolorem dolorum, earum est expedita hic illo impedit\r\n            nesciunt\r\n            placeat ratione reiciendis, tempore vel velit veritatis voluptas! Blanditiis corporis dicta, dolore\r\n            explicabo\r\n            fugiat fugit harum id in ipsa ipsum magni maxime mollitia nihil odit quam quibusdam quod rem repudiandae\r\n            similique velit! Accusantium animi cumque deleniti ducimus harum, illo minima tempore ut vitae.\r\n          </p>\r\n          <a class=\"uk-button uk-button-large uk-button-default uk-align-right\">Подробнее</a>\r\n        </div>\r\n      </div>\r\n    </section>\r\n    <section class=\"uk-height-1-1 uk-overflow-hidden uk-position-relative design\">\r\n      <div class=\"info uk-position-absolute uk-flex uk-flex-middle uk-light\">\r\n        <div class=\"\">\r\n          <h2 class=\"uk-text-bold uk-text-uppercase\">Дизайнеры</h2>\r\n          <p class=\"\">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Adipisci aliquid aperiam at\r\n            aut cumque delectus dicta dignissimos distinctio dolorem dolorum, earum est expedita hic illo impedit\r\n            nesciunt\r\n            placeat ratione reiciendis, tempore vel velit veritatis voluptas! Blanditiis corporis dicta, dolore\r\n            explicabo\r\n            fugiat fugit harum id in ipsa ipsum magni maxime mollitia nihil odit quam quibusdam quod rem repudiandae\r\n            similique velit! Accusantium animi cumque deleniti ducimus harum, illo minima tempore ut vitae.\r\n          </p>\r\n          <a class=\"uk-button uk-button-large uk-button-default uk-align-right\">Подробнее</a>\r\n        </div>\r\n      </div>\r\n    </section>\r\n  </div>\r\n</div>\r\n<div class=\"\">\r\n  <div class=\"\">\r\n    <h2 class=\"uk-margin-large-top uk-margin-large-bottom uk-align-center uk-text-center uk-text-uppercase\">Мы в соц\r\n      сетях</h2>\r\n    <div class=\"uk-container \">\r\n      <div class=\"uk-grid\">\r\n\r\n        <div class=\"uk-card uk-card-body uk-width-1-3 uk-flex uk-flex-column uk-flex-middle uk-flex-center\">\r\n          <a class=\"uk-section-primary uk-border-circle\" href=\"#\" uk-icon=\"icon: pinterest; ratio: 1.2\"></a>\r\n          <img class=\"uk-margin-top uk-margin-bottom\" src=\"" + __webpack_require__(18) + "\" alt=\"\">\r\n          <a class='uk-button uk-button-primary' href=\"#\">Подробнее</a>\r\n        </div>\r\n        <div class=\"uk-card uk-card-body uk-width-1-3 uk-flex uk-flex-column uk-flex-middle uk-flex-center\">\r\n          <a class=\"uk-section-primary uk-border-circle\" href=\"#\" uk-icon=\"icon: pinterest; ratio: 1.2\"></a>\r\n          <img class=\"uk-margin-top uk-margin-bottom\" src=\"" + __webpack_require__(18) + "\" alt=\"\">\r\n          <a class='uk-button uk-button-primary' href=\"#\">Подробнее</a>\r\n        </div>\r\n        <div class=\"uk-card uk-card-body uk-width-1-3 uk-flex uk-flex-column uk-flex-middle uk-flex-center\">\r\n          <a class=\"uk-section-primary uk-border-circle\" href=\"#\" uk-icon=\"icon: pinterest; ratio: 1.2\"></a>\r\n          <img class=\"uk-margin-top uk-margin-bottom\" src=\"" + __webpack_require__(18) + "\" alt=\"\">\r\n          <a class='uk-button uk-button-primary' href=\"#\">Подробнее</a>\r\n        </div>\r\n      </div>\r\n    </div>\r\n  </div>\r\n  <footer class=\"footer uk-section-secondary uk-padding-large uk-padding-remove-left uk-padding-remove-right\">\r\n    <div class=\"uk-flex uk-flex-between uk-flex-top uk-container \">\r\n      <div class=\"uk-padding-small\">\r\n        <div class=\"logo uk-text-uppercase\">\r\n          Illuminator<br>\r\n          <span class=\"logo__span uk-text-lowercase\">дизайнерские светильники</span>\r\n        </div>\r\n      </div>\r\n      <ul class=\"uk-nav uk-nav-default\">\r\n        <li class=\"uk-parent\">\r\n          <a class=\"uk-text-large uk-padding-remove\" href=\"#\">О нас</a>\r\n          <ul class=\"uk-nav-sub uk-padding-remove\">\r\n            <li class=\"\"><a href=\"#\" class=\"footer__a\">О магазину</a></li>\r\n            <li class=\"\"><a href=\"#\" class=\"footer__a\">Новости</a></li>\r\n            <li class=\"\"><a href=\"#\" class=\"footer__a\">Акции</a></li>\r\n            <li class=\"\"><a href=\"#\" class=\"footer__a\">Контакты</a></li>\r\n          </ul>\r\n        </li>\r\n      </ul>\r\n      <ul class=\"uk-nav uk-nav-default\">\r\n        <li class=\"uk-parent\">\r\n          <a class=\"uk-text-large uk-padding-remove\" href=\"#\">Каталог</a>\r\n          <ul class=\"uk-nav-sub uk-padding-remove\">\r\n            <li class=\"footer__li\"><a href=\"#\" class=\"footer__a\">Информация</a></li>\r\n            <li class=\"footer__li\"><a href=\"#\" class=\"footer__a\">Дизайнерский</a></li>\r\n            <li class=\"footer__li\"><a href=\"#\" class=\"footer__a\">Ретро-лампы</a></li>\r\n            <li class=\"footer__li\"><a href=\"#\" class=\"footer__a\">Точечные</a></li>\r\n            <li class=\"footer__li\"><a href=\"#\" class=\"footer__a\">Комплектующие</a></li>\r\n          </ul>\r\n        </li>\r\n      </ul>\r\n      <ul class=\"uk-nav uk-nav-default\">\r\n        <li class=\"uk-parent\">\r\n          <a class=\"uk-text-large uk-padding-remove\" href=\"#\">Информация</a>\r\n          <ul class=\"uk-nav-sub uk-padding-remove\">\r\n            <li class=\"footer__li\"><a href=\"#\" class=\"footer__a\">Вопросы</a></li>\r\n            <li class=\"footer__li\"><a href=\"#\" class=\"footer__a\">Доставка</a></li>\r\n            <li class=\"footer__li\"><a href=\"#\" class=\"footer__a\">Оплаты</a></li>\r\n            <li class=\"footer__li\"><a href=\"#\" class=\"footer__a\">Возврат/Обмен</a></li>\r\n            <li class=\"footer__li\"><a href=\"#\" class=\"footer__a\">Оферта</a></li>\r\n          </ul>\r\n        </li>\r\n      </ul>\r\n      <ul class=\"uk-nav uk-nav-default\">\r\n        <li class=\"uk-parent\">\r\n          <a class=\"uk-text-large uk-padding-remove\" href=\"#\">Подписка</a>\r\n          <ul class=\"uk-nav-sub uk-padding-remove uk-margin-small-top\">\r\n            <div class=\"uk-flex\">\r\n              <input type=\"text\" class=\"uk-input margin-top\" placeholder=\"Ваш e-mail\">\r\n              <button class=\"uk-button uk-button-default uk-button-small uk-margin-small-left\">ОК</button>\r\n            </div>\r\n          </ul>\r\n        </li>\r\n      </ul>\r\n    </div>\r\n  </footer>\r\n</div>\r\n<div class=\"uk-position-fixed uk-position-center-right\">\r\n  <ul class=\"fixed-nav__ul uk-padding-remove\">\r\n    <li\r\n      class=\"fixed-nav__li uk-flex uk-flex-middle uk-flex-center fixed-nav__li--social uk-background-default uk-margin-remove\">\r\n      <a href=\"#\" uk-icon=\"icon: wordpress\"></a>\r\n    </li>\r\n    <li\r\n      class=\"fixed-nav__li uk-flex uk-flex-middle uk-flex-center fixed-nav__li--social uk-background-default uk-margin-remove\">\r\n      <a href=\"#\" uk-icon=\"icon: facebook\"></a>\r\n    </li>\r\n    <li\r\n      class=\"fixed-nav__li uk-flex uk-flex-middle uk-flex-center fixed-nav__li--social uk-background-default uk-margin-remove\">\r\n      <a href=\"#\" uk-icon=\"icon: pinterest\"></a>\r\n    </li>\r\n    <li class=\"fixed-nav__li uk-flex uk-flex-middle uk-flex-center uk-background-secondary\"><a href=\"#\"\r\n                                                                                               uk-icon=\"icon: minus\"></a>\r\n    </li>\r\n    <li class=\"fixed-nav__li uk-flex uk-flex-middle uk-flex-center scroll-control__up uk-background-secondary\">\r\n      <a href=\"#\" uk-icon=\"icon: arrow-up\"></a>\r\n    </li>\r\n    <li class=\"fixed-nav__li uk-flex uk-flex-middle uk-flex-center scroll-control__info uk-background-secondary\">1/4\r\n    </li>\r\n    <li class=\"fixed-nav__li uk-flex uk-flex-middle uk-flex-center scroll-control__down uk-background-secondary\">\r\n      <a href=\"#\" uk-icon=\"icon: arrow-down\"></a>\r\n    </li>\r\n  </ul>\r\n</div>\r\n<script src=\"../lib/onepagescroll.min.js\"></script>\r\n</body>\r\n</html>";
